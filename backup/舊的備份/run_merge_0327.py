...
class Rules:
    ...
    # 模板設定（0327）
    TEMPLATE_NAME: str = "選會員樣板0327.xlsx"
...
def collect_monthly_claim_summaries(wb_src) -> Dict[str, Dict[str, float]]:
    ...
    for sheet_name in wb_src.sheetnames:
        ...
        amount_col = find_column_exact(hmap, ["總額", "申請金額"])
...
def _score_fee(avg_amount_114: Any, avg_amount_115: Any) -> int:
    amt114 = parse_float(avg_amount_114)
    amt115 = parse_float(avg_amount_115)
...
def calc_score(
    *,
    ...
    fee_score = _score_fee(avg_amount_114, avg_amount_115)
...
def _compute_all_derived(
    ...
    for rr in range(data_start, last_row + 1):
        ...
        avg_amount_114 = ws.cell(rr, _c_r114).value if _c_r114 else None
        avg_amount_115 = ws.cell(rr, _c_s115).value if _c_s115 else None
        ...
        score, breakdown = calc_score(
            ...
            age=age, sex=sex,
            avg_amount_114=avg_amount_114,
            avg_amount_115=avg_amount_115,
